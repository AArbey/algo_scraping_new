...
FIG_DIR = "/home/scraping/algo_scraping/exploration/rakuten/figures/pred1"
os.makedirs(FIG_DIR, exist_ok=True)

# 1. Charger les données nettoyées
df = pd.read_csv("/home/scraping/algo_scraping/exploration/rakuten/data_cleaned_rakuten.csv", parse_dates=["Timestamp"])
